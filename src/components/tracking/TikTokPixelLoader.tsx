...
// Mount only under app/[locale]/layout.tsx (inside CookieConsentProvider). Never
// mount under app/admin/** — the pixel must never be present on backoffice pages.
// Mirrors MetaPixelLoader.tsx exactly.
