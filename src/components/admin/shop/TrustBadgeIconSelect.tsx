...
export default function TrustBadgeIconSelect({ value, onChange }: Props) {
  ...
  const Icon = getTrustBadgeIcon(value);

  // Anchor the fixed panel to the trigger; flip upward when it would clip.
  useLayoutEffect(() => {
  ...
  return (
    <>
      ...
      >
        <span className={styles.iconChip}><Icon size={15} /></span>
