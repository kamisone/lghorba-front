 ...
 * time here, unlike in middleware where Next.js inlines `process.env` values
 * at build time — keeping the backend call here avoids relying on a
 * build-time-baked URL that may not match the runtime environment.
 */
