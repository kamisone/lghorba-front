  ...
  return (
    <div className={styles.container}>
      ...
      <div style={{ padding: "64px 0", textAlign: "center", color: "#9ca3af" }}>
        ...
        <p style={{ fontSize: 16, fontWeight: 500, color: "#374151", marginBottom: 8 }}>Currency settings are in development</p>
        <p style={{ fontSize: 14, maxWidth: 400, margin: "0 auto" }}>
          Manage supported currencies and exchange rates. The store currently operates in EUR.
        </p>
      </div>
    </div>
  );
